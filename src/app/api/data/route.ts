...
const Aboutdata: aboutdata[] = [
  {
    ...
    paragraph:
      'Creator World is designed for creators — not enterprises. Launch fast, look professional, and focus on creating instead of managing tech.',
    link: 'Learn more',
  },
  {
    heading: 'Sell Anything Digital',
    imgSrc: '/images/aboutus/imgTwo.svg',
    paragraph:
      'Sell PDFs, courses, memberships, consultations, workshops, and more — all from a single creator storefront.',
    link: 'Learn more',
  },
  {
    ...
    paragraph:
      'Accept payments via Stripe & Razorpay. Automated delivery, invoices, and payouts — no manual work.',
    link: 'Learn more',
  },
]
